...
- итоговая страница сборки с диаграммой производительности, ссылками поиска товаров и демо-заказом;
...
После запуска dev-сервера главная страница доступна по `/`, конфигуратор — по `/configurator.html`, итоговая сборка — по `/summary.html`.
